...
public class EmailService {
    ...
    public void sendSuccessFundDonationDetails(MailRequest mailBody, Map<String, Object> variables) throws Exception {
        MimeMessage mimeMessage = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true);
        ...
        Template template = freemarkerConfig.getTemplate("email-fund-donation-details.ftl");
        String htmlContent = FreeMarkerTemplateUtils.processTemplateIntoString(template, variables);
    ...
    public void sendSuccessNonFundDonationDetails(MailRequest mailBody, Map<String, Object> variables) throws Exception {
        MimeMessage mimeMessage = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true);
        ...
        Template template = freemarkerConfig.getTemplate("email-nonfund-donation-details.ftl");
        String htmlContent = FreeMarkerTemplateUtils.processTemplateIntoString(template, variables);
